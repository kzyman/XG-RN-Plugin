...
import AndroidApi from './node_modules/tpns_rn_plugin/AndroidApi.js'
    ...
    render() {
        return (
			...
			<View style={{flexDirection:'row'}}>
			 <View style={styles.itemStyle}>
			    <Button title="绑定一个标签"
                        onPress={() => XgPush.bindWithIdentifier('332211',2)
                        }/>
			</View>

			<View style={styles.itemStyle}>
                <Button title="解绑一个标签"
                        onPress={() => XgPush.unbindWithIdentifier('332211', 2)
                        }/>
			</View>
			</View>
			...
			<View style={styles.itemStyle}>
			    <Button title="绑定一个账号"
                        onPress={() => XgPush.bindWithIdentifier('123321', 1)
                        }/>
			</View>

			<View style={styles.itemStyle}>
                <Button title="解绑一个账号"
                        onPress={() => XgPush.unbindWithIdentifier('123321', 1)
                        }/>
			</View>
			</View>
			...
			<View style={styles.itemStyle}>
			    <Button title="绑定多个标签"
                        onPress={() => XgPush.bindWithIdentifiers({tags: ["123", "321", "23457"]}, 2)
                        }/>
			</View>
			<View style={styles.itemStyle}>
			    <Button title="解绑多个标签"
                        onPress={() => XgPush.unbindWithIdentifiers({tags: ["123", "321", "23457"]}, 2)
                        }/>
			</View>
			</View>
